...
app.post("/webhook", async (req, res) => {
    ...
    if (update.message) {
        ...
        // ✅ Check if AI response is required
        let responseText;
        if (text.toLowerCase().includes("ajura")) {
            responseText = await getAjuraAIResponse(text);
        } else {
            responseText = `Ajura AI received: ${text}`;
        }

        // ✅ Send AI or Default Response
